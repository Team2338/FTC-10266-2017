...
public class AutoRedBack extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(runtime.seconds() >= 10.1 && runtime.seconds() <= 10.9) {
                if (ColorBlue == 1 ) {
            ...
            //STOP
            if(runtime.seconds() >= 11.0 && runtime.seconds() <= 13.0) {
            ...
            if (runtime.seconds() >= 23.1 && runtime.seconds() <= 23.9) {
            ...
            if(runtime.seconds() >= 24.0 && runtime.seconds() <= 24.2) {
            ...
            //STOP
            if(runtime.seconds() >= 24.3 && runtime.seconds() <= 25.0) {
            ...
            //FREEZE
            if (runtime.seconds() >= 25.3 && runtime.seconds() <= 26.0) {
                telemetry.addData("STOP After Spin ", "Running: " + runtime.toString());
                backleftmotor.setPower(0);     //STOP
                backrightmotor.setPower(0);    //STOP

            }
            if (runtime.seconds() >= 26.1 && runtime.seconds() <= 26.2) {
                telemetry.addData("STOP After Spin ", "Running: " + runtime.toString());
            ...
            //Stop
            if (runtime.seconds() >= 26.3 && runtime.seconds() <= 30) {
                telemetry.addData("STOP END ", "Running: " + runtime.toString());
                backleftmotor.setPower(0);
                backrightmotor.setPower(0);
