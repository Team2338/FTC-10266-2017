...
*/
            ...
            if(runtime.seconds() >= 13.1 && runtime.seconds() <= 13.93) {
            ...
            //PUSH glyph into box
            if (runtime.seconds() >= 23.1 && runtime.seconds() <= 23.4) {
                telemetry.addData("STOP After Spin ", "Running: " + runtime.toString());
            ...
            //FREEZE
            if (runtime.seconds() >= 23.5 && runtime.seconds() <= 24.0) {
                telemetry.addData("STOP After Spin ", "Running: " + runtime.toString());
                backleftmotor.setPower(0);     //STOP
                backrightmotor.setPower(0);    //STOP
            }
            if (runtime.seconds() >= 24.1 && runtime.seconds() <= 24.3) {
                telemetry.addData("STOP After Spin ", "Running: " + runtime.toString());
                backleftmotor.setPower(.4);     //BWD
                backrightmotor.setPower(-.4);     //BWD
            ...
            //Stop
            if (runtime.seconds() >= 24.4 && runtime.seconds() <= 24.9) {
                telemetry.addData("STOP END ", "Running: " + runtime.toString());
                backleftmotor.setPower(0);
                backrightmotor.setPower(0);
            ...
            //back
            if (runtime.seconds() >= 25.0 && runtime.seconds() <= 25.3) {
                telemetry.addData("STOP END ", "Running: " + runtime.toString());
                backleftmotor.setPower(.4);   //back
                backrightmotor.setPower(-.4); //back

            }
            //Stop
            if (runtime.seconds() >= 25.4 && runtime.seconds() <= 30) {
                telemetry.addData("STOP END ", "Running: " + runtime.toString());
                backleftmotor.setPower(0);
                backrightmotor.setPower(0);
