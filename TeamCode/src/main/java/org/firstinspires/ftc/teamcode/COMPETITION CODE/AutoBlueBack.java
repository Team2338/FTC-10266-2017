...
*/
            ...
            if (runtime.seconds() >= 5.1 && runtime.seconds() <= 5.47) {
            ...
            //STOP
            if(runtime.seconds() >= 5.48 && runtime.seconds() <= 6.0) {
            ...
            //MOVE FORWARD
            if(runtime.seconds() >= 10.1 && runtime.seconds() <= 10.6) {
                if (ColorBlue == 1 ) {
                    telemetry.addData("In Move Backwards BLUE ", "Running: " + runtime.toString());
                    backleftmotor.setPower(.4);     //Faster Backwards
            ...
            //STOP
            if(runtime.seconds() >= 10.7 && runtime.seconds() <= 11) {
                telemetry.addData("STOP After Knock ", "Running: " + runtime.toString());
            ...
            if(runtime.seconds() >= 11.1 && runtime.seconds() <= 13.5) {
                    telemetry.addData("In Spin BLUE ", "Running: " + runtime.toString());
                    backleftmotor.setPower(.4);     //Faster FORWARD
                    backrightmotor.setPower(.4);     //Faster FORWARD
            }

            //STOP MOTORS
            if(runtime.seconds() >= 13.6 && runtime.seconds() <= 15.0) {
            ...
            if(runtime.seconds() >= 15.1 && runtime.seconds() <= 16.0) {
                if (ColorBlue == 1 ) {
                    telemetry.addData("In Move Forwards BLUE ", "Running: " + runtime.toString());
                    backleftmotor.setPower(-.4);     //Faster Forwards
                    backrightmotor.setPower(.4);     //Faster Forwards
                }
                else {
            ...
            //STOP
            if(runtime.seconds() >= 16.1 && runtime.seconds() <= 17.0) {
            ...
            //DROP
            if(runtime.seconds() >= 17.1 && runtime.seconds() <= 20) {
            ...
            //BACK
            if(runtime.seconds() >= 20.1 && runtime.seconds() <= 20.5) {
                telemetry.addData("In Move Backward RED ", "Running: " + runtime.toString());
                backleftmotor.setPower(.4);     //Backwards
                backrightmotor.setPower(-.4);     //Backwards

            }

            //STOP
            if(runtime.seconds() >= 20.6 && runtime.seconds() <= 25.0) {
                telemetry.addData("STOP After Spin ", "Running: " + runtime.toString());
                backleftmotor.setPower(0);     //Stop
                backrightmotor.setPower(0);     //Stop
            ...
            //CLOSE
            if(runtime.seconds() >= 25.1 && runtime.seconds() <= 25.9) {
                telemetry.addData("STOP END ", "Running: " + runtime.toString());
            ...
            //PUSH glyph into box
            if(runtime.seconds() >= 26.0 && runtime.seconds() <= 26.1) {
                telemetry.addData("STOP After Spin ", "Running: " + runtime.toString());
            ...
            //FREEZE
            if(runtime.seconds() >= 26.2 && runtime.seconds() <= 27.0) {
                telemetry.addData("STOP After Spin ", "Running: " + runtime.toString());
                backleftmotor.setPower(0);     //STOP
                backrightmotor.setPower(0);    //STOP

            }
            if (runtime.seconds() >= 27.1 && runtime.seconds() <= 27.3) {
                telemetry.addData("STOP After Spin ", "Running: " + runtime.toString());
            ...
            //Stop
            if (runtime.seconds() >= 27.4 && runtime.seconds() <= 30) {
                telemetry.addData("STOP END ", "Running: " + runtime.toString());
                backleftmotor.setPower(0);
                backrightmotor.setPower(0);
